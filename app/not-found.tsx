...
export default function NotFound() {
  return (
    <section className="mx-auto max-w-2xl px-4 py-24 text-center">
      ...
      <p className="mt-3 text-navy-ink/70">Try our practice areas, or build your confidential Estate Snapshot.</p>
      <div className="mt-8 flex justify-center gap-4">
        ...
        <Link href="/estate-snapshot" className="cta-gold rounded-sm bg-gold px-5 py-3 font-semibold text-navy-ink">Estate Snapshot</Link>
      </div>
    </section>
  );
}
